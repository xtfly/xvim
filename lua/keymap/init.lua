...
local plug_map = {
    ...
    ["n|<Leader>ws"]     = map_cmd("<cmd>lua vim.lsp.buf.workspace_symbol()<CR>"):with_noremap():with_silent(),
    ["n|<Leader>dl"]     = map_cr('Lspsaga show_line_diagnostics'):with_noremap():with_silent(),
    ["n|<Leader>ct"]      = map_args("Template"),
    ["n|<Leader>df"]     = map_cu('DashboardNewFile'):with_noremap():with_silent(),
    -- Plugin nvim-tree
    ["n|<F2>"]      = map_cr('NvimTreeToggle'):with_noremap():with_silent(),
    ["n|<F4>"]      = map_cr('NvimTreeFindFile'):with_noremap():with_silent(),
    ...
    -- Plugin Telescope
    ["n|<Leader>fo"]     = map_cu('Telescope'):with_noremap():with_silent(),
    ...
    -- Plugin QuickRun
    ["n|<F5>"]     = map_cr("<cmd> lua require'internal.quickrun'.run_command()"):with_noremap():with_silent(),
    -- Plugin Vista
    ["n|<F3>"]      = map_cu('Vista'):with_noremap():with_silent(),
